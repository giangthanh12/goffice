<?php
class potential_customer extends Controller
{
    ...
    function __construct()
    {
        parent::__construct();
        $model = new model();
        $checkMenuRole = $model->checkMenuRole('potential_customer');
        if ($checkMenuRole == false)
            header('location:' . HOME);
        $funcs = $model->getFunctions('potential_customer');
    ...
    function index()
    {
        ...
        $this->view->render("potential_customer/index");
    ...
    function importExcel()
    {
        ...
        try {
            ...
            for ($row = 3; $row <= $highestRow; $row++) {
                ...
                $businessAddress = $objPHPExcel->getActiveSheet()->getCell("K$row")->getValue();
                $businessAddress = $objPHPExcel->getActiveSheet()->getCell("L$row")->getValue();
