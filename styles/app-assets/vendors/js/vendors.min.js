...
!function (e, t) {
    ...
    var k = function (e) {
        var t, n, i, o, r, a, s, l, c, u, p, f, h, d, g, m, y, v, b, x = "sizzle" + 1 * new Date, w = e.document, _ = 0,
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === o ? function (e) {
                        ...
                        var c, u, p, f, h, d, g = r !== a ? "nextSibling" : "previousSibling", m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            if (d = [a ? m.firstChild : m.lastChild], a && v) {
                                for (b = (h = (c = (u = (p = (f = m)[x] || (f[x] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] || [])[0] === _ && c[1]) && c[2], f = h && m.childNodes[h]; f = ++h && f && f[g] || (b = h = 0) || d.pop();) if (1 === f.nodeType && ++b && f === t) {
                                    u[e] = [_, h, b];
                                    break
                                }
        ...
        function ke(e, t, n, i, o, r) {
            return i && !i[x] && (i = ke(i)), o && !o[x] && (o = ke(o, r)), ce((function (r, a, s, l) {
                var c, u, p, f = [], h = [], d = a.length, g = r || function (e, t, n) {
                        ...
                        return n
                    }(t || "*", s.nodeType ? [s] : s, []), m = !e || !r && t ? g : _e(g, f, e, s, l),
                    y = n ? o || (r ? e : d || i) ? [] : a : m;
            ...
            if (!m) {
                ...
                (m = S(e, (o = d, s = 0 < (r = p).length, l = 0 < o.length, u = function (e, t, n, a, u) {
                    ...
                    for (u && (c = t == h || t || u); v !== T && null != (p = k[v]); v++) {
                        if (l && p) {
                            for (d = 0, t || p.ownerDocument == h || (f(p), n = !g); m = o[d++];) if (m(p, t || h, n)) {
                                a.push(p);
                                break
                            }
                            u && (_ = E)
    ...
    function be(e, t, n, i, o) {
        ...
        for (p.textContent = "", h = 0; r = f[h++];) if (i && -1 < w.inArray(r, i)) o && o.push(r); else if (c = oe(r), a = me(p.appendChild(r), "script"), c && ye(a), n) for (u = 0; r = a[u++];) de.test(r.type || "") && n.push(r);
        return p
    }
    ...
    w.event = {
        global: {}, add: function (e, t, n, i, o) {
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(I) || [""]).length; c--;) if (h = g = (s = xe.exec(t[c]) || [])[1], d = (s[2] || "").split(".").sort(), h) {
    ...
    function je(e, t, n, i) {
        ...
        if (f && (a = (o = be(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
            ...
            if (l) for (u = s[s.length - 1].ownerDocument, w.map(s, Ne), p = 0; p < l; p++) c = s[p], de.test(c.type || "") && !Q.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {nonce: c.nonce || c.getAttribute("nonce")}, u) : v(c.textContent.replace(Ae, ""), c, u))
        }
        return e
    }
    ...
    w.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (a = me(u), i = 0, o = (r = me(e)).length; i < o; i++) s = r[i], "input" === (c = (l = a[i]).nodeName.toLowerCase()) && fe.test(s.type) ? l.checked = s.checked : "input" !== c && "textarea" !== c || (l.defaultValue = s.defaultValue);
            if (t) if (n) for (r = r || me(e), a = a || me(u), i = 0, o = r.length; i < o; i++) Me(r[i], a[i]); else Me(e, u);
    ...
    var We = ["Webkit", "Moz", "ms"], ze = m.createElement("div").style, Ue = {};
    ...
    function Ge(e, t, n) {
        var i = Pe(e), o = (!h.boxSizingReliable() || n) && "border-box" === w.css(e, "boxSizing", !1, i), r = o,
            a = qe(e, t, i), s = "offset" + t[0].toUpperCase() + t.slice(1);
        if (Ie.test(a)) {
            if (!n) return a;
            a = "auto"
        }
    ...
    w.extend({
        ...
        w.cssHooks[t] = {
            get: function (e, n, i) {
                ...
                var o, r = Pe(e), a = !h.scrollboxSize() && "absolute" === r.position,
                    s = (a || i) && "border-box" === w.css(e, "boxSizing", !1, r), l = i ? Ke(e, t, i, s, r) : 0;
    ...
    function ct(e, t, n) {
        ...
        }(u, c.opts.specialEasing); r < a; r++) if (i = ct.prefilters[r].call(c, e, u, c.opts)) return d(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
    ...
    w.Animation = w.extend(ct, {
        tweeners: {
            ...
            }))), l = !1, h) l || (m ? "hidden" in m && (g = m.hidden) : m = Q.access(e, "fxshow", {display: c}), r && (m.hidden = !g), g && ce([e], !0), f.done((function () {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && this.queue(e || "fx", []), this.each((function () {
                ...
                if (o) a[o] && a[o].stop && i(a[o]); else for (o in a) a[o] && a[o].stop && ot.test(o) && i(a[o]);
    ...
    w.fn.extend({
        ...
        addClass: function (e) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : d(e) ? this.each((function (n) {
                ...
                var t, o, r, a;
                if (i) for (o = 0, r = w(this), a = mt(e); t = a[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else void 0 !== e && "boolean" !== n || ((t = gt(this)) && Q.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Q.get(this, "__className__") || ""))
            }))
        }, hasClass: function (e) {
            var t, n, i = 0;
    ...
    w.extend(w.event, {
        trigger: function (t, n, i, o) {
            var r, a, s, l, c, p, f, h, y = [i || m], v = u.call(t, "type") ? t.type : t,
            ...
            if (a = h = s = i = i || m, 3 !== i.nodeType && 8 !== i.nodeType && !vt.test(v + w.event.triggered) && (-1 < v.indexOf(".") && (v = (b = v.split(".")).shift(), b.sort()), c = v.indexOf(":") < 0 && "on" + v, (t = t[w.expando] ? t : new w.Event(v, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : w.makeArray(n, [t]), f = w.event.special[v] || {}, o || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                ...
                for (r = 0; (a = y[r++]) && !t.isPropagationStopped();) h = a, t.type = 1 < r ? l : f.bindType || v, (p = (Q.get(a, "events") || Object.create(null))[t.type] && Q.get(a, "handle")) && p.apply(a, n), (p = c && a[c]) && p.apply && V(a) && (t.result = p.apply(a, n), !1 === t.result && t.preventDefault());
    ...
    var At = /%20/g, Lt = /#.*$/, Ot = /([?&])_=[^&]*/, Nt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Mt = /^(?:GET|HEAD)$/,
        jt = /^\/\//, Dt = {}, It = {}, Pt = "*/".concat("*"), Rt = m.createElement("a");
    ...
    Rt.href = xt.href, w.extend({
        ...
        ajax: function (t, n) {
            ...
            var i, o, r, a, s, l, c, u, p, f, h = w.ajaxSetup({}, n), d = h.context || h,
                g = h.context && (d.nodeType || d.jquery) ? w(d) : w.event, y = w.Deferred(),
            ...
            function T(t, n, a, l) {
                ...
                }(h, E, a)), !p && -1 < w.inArray("script", h.dataTypes) && w.inArray("json", h.dataTypes) < 0 && (h.converters["text script"] = function () {
                }), x = function (e, t, n, i) {
    ...
    var Wt = {0: 200, 1223: 204}, zt = w.ajaxSettings.xhr();
    ...
    function m(e, n) {
        var o = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], a = r(10), s = "HTML" === n.nodeName,
            l = g(e), c = g(n), p = i(e), f = t(n), h = parseFloat(f.borderTopWidth), m = parseFloat(f.borderLeftWidth);
    ...
    function y(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], n = e.ownerDocument.documentElement,
            i = m(e, n), o = Y(n.clientWidth, window.innerWidth || 0), r = Y(n.clientHeight, window.innerHeight || 0),
            ...
            shift: {
                ...
                order: 500, enabled: !0, fn: function (e, n) {
                    ...
                    var r = e.placement.split("-")[0], a = e.offsets, s = a.popper, l = a.reference,
                        ...
                        f = p.toLowerCase(), h = c ? "left" : "top", g = c ? "bottom" : "right", m = E(o)[u];
                    l[g] - m < s[f] && (e.offsets.popper[f] -= s[f] - (l[g] - m)), l[f] + m > s[g] && (e.offsets.popper[f] += l[f] + m - s[g]), e.offsets.popper = d(e.offsets.popper);
                    var y = l[f] + l[u] / 2 - m / 2, v = t(e.instance.popper), b = parseFloat(v["margin" + p]),
                        x = parseFloat(v["border" + p + "Width"]), w = y - e.offsets.popper[f] - b - x;
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    ...
                    var s, l, c = void 0 === r ? t.gpuAcceleration : r, u = a(e.instance.popper), p = g(u),
                        ...
                        m = "right" === i ? "left" : "right", y = N("transform");
                    if (l = "bottom" == d ? "HTML" === u.nodeName ? -u.clientHeight + h.bottom : -p.height + h.bottom : h.top, s = "right" == m ? "HTML" === u.nodeName ? -u.clientWidth + h.right : -p.width + h.right : h.left, c && y) f[y] = "translate3d(" + s + "px, " + l + "px, 0)", f[d] = 0, f[m] = 0, f.willChange = "transform"; else {
                        var v = "bottom" == d ? -1 : 1, b = "right" == m ? -1 : 1;
    ...
    var g = "carousel", m = o.default.fn[g],
        y = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, v = {
            ...
            return t.next = function () {
                ...
                return this.each((function () {
                    var n = o.default(this).data("bs.carousel"), i = l({}, y, o.default(this).data());
 ...
 */
    function (e, t) {
        ...
        function v(e, t) {
            ...
            var r = t[0], a = t[1], s = t[2], u = t[3], p = t[4], f = t[5], h = t[6], d = t[7], m = t[8], y = e.element,
        ...
        var T = {
            ...
            "click-rail": function (e) {
                ...
                if (T.supportsTouch || T.supportsIePointer) {
                    var f = i.element, h = {}, d = 0, m = {}, y = null;
    ...
    var ue = s((function (e, t, n) {
        ...
        ge = he && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent), me = "touch", ye = "mouse",
    ...
    var Pe = {pointerdown: be, pointermove: xe, pointerup: we, pointercancel: _e, pointerout: _e},
        Re = {2: me, 3: "pen", 4: ye, 5: "kinect"}, He = "pointerdown", qe = "pointermove pointerup pointercancel";
    e.MSPointerEvent && !e.PointerEvent && (He = "MSPointerDown", qe = "MSPointerMove MSPointerUp MSPointerCancel"), l(M, _, {
        handler: function (e) {
            var t = this.store, n = !1, i = e.type.toLowerCase().replace("ms", ""), o = Pe[i],
                r = Re[e.pointerType] || e.pointerType, a = r == me, s = y(t, e.pointerId, "pointerId");
        ...
        function t(t, i) {
            ...
            if (!(i = e.extend({}, e.blockUI.defaults, i || {})).ignoreIfBlocked || !e(t).data("blockUI.isBlocked")) {
                ...
                if (m && (i.theme ? w.find(".ui-widget-content").append(m) : w.append(m), (m.jquery || m.nodeType) && e(m).show()), (c || i.forceIframe) && i.showOverlay && b.show(), i.fadeIn) {
                    var N = i.onBlock ? i.onBlock : l, M = i.showOverlay && !m ? N : l, j = m ? N : l;
    ...
    var t, n, i, o, r, a, s, l, c, u, p, f, h, d, g, m, y, v, b, x, w, _, k, E, T, S, C, A, L, O, N, M, j, D, I, P, R,
        H, q, F, W, z, U, B, X, Y, V = [].slice, $ = {}.hasOwnProperty, Q = function (e, t) {
    ...
    for (v = {
        ...
        for (var e, t, n, i = arguments[0], o = 2 <= arguments.length ? V.call(arguments, 1) : [], r = 0, a = o.length; r < a; r++) if (t = o[r]) for (e in t) $.call(t, e) && (n = t[e], null != i[e] && "object" == typeof i[e] && null != n && "object" == typeof n ? b(i[e], n) : i[e] = n);
        return i
    }, d = function (e) {
    ...
    Q(J, Y = Error), r = J, Z.prototype.getElement = function () {
    ...
    }, i = oe, re.prototype.states = {loading: 0, interactive: 50, complete: 100}, Y = re, Q = function () {
    ...
    }), l = {ajax: t, elements: w, document: Y, eventLag: Q}, (T = function () {
        var e, t, i, o, r, s, u, p;
        ...
        return a.running = !0, g.render(), e = S(), m = !1, h = O((function (t, n) {
            g.progress;
            for (var i, o, r, s, l, u, p, f, h, d, y = u = 0, v = !0, b = p = 0, x = I.length; p < x; b = ++p) for (D = I[b], l = null != N[b] ? N[b] : N[b] = [], r = f = 0, h = (o = null != (d = D.elements) ? d : [D]).length; f < h; r = ++f) s = o[r], v &= (s = null != l[r] ? l[r] : l[r] = new c(s)).done, s.done || (y++, u += s.tick(t));
  ...
  */
        ...
        t.default = function () {
            ...
            Array.from(t).forEach((function (t) {
                return function (e) {
                    ...
                    if (icons.includes(a) == false)
                        a = 'chevron-right';
                    // Gọi hàm xuất SVG
                    var s = r.default[a].toSvg(i({}, t, n, {class: (0, o.default)(t.class, n.class)}));
                    var l = (new DOMParser).parseFromString(s, "image/svg+xml").querySelector("svg");
        ...
        e.exports = {
            ...
            'user-define': '<g clip-path="url(#clip0_802_2076)">' +
                '<path d="M8.99999 9.99999C11.7614 9.99999 14 7.76142 14 5C14 2.23857 11.7614 0 8.99999 0C6.23857 0 4 2.23857 4 5C4 7.76142 6.23857 9.99999 8.99999 9.99999Z" fill="#B4B7BD"/>' +
                '<path d="M11.534 20.8C11.013 19.898 11.117 18.787 11.737 18C11.117 17.213 11.013 16.103 11.534 15.2L12.343 13.8C12.788 13.029 13.618 12.55 14.509 12.55C14.631 12.55 14.751 12.559 14.87 12.576C14.903 12.494 14.945 12.417 14.986 12.339C14.446 12.126 13.863 12 13.25 12H4.75C2.131 12 0 14.131 0 16.75V20.25C0 20.664 0.336 21 0.75 21H11.649L11.534 20.8Z" fill="#B4B7BD"/>' +
                '<path d="M21.7033 18.469C21.7233 18.314 21.7503 18.16 21.7503 18C21.7503 17.839 21.7223 17.686 21.7033 17.531L22.6043 16.849C22.8053 16.697 22.8613 16.419 22.7353 16.2L21.9263 14.8C21.8003 14.582 21.5313 14.491 21.2993 14.589L20.2623 15.026C20.0093 14.833 19.7403 14.663 19.4433 14.539L19.3053 13.438C19.2733 13.188 19.0613 13 18.8093 13H17.1923C16.9403 13 16.7273 13.188 16.6963 13.438L16.5583 14.539C16.2613 14.663 15.9913 14.834 15.7393 15.026L14.7023 14.589C14.4703 14.491 14.2013 14.581 14.0753 14.8L13.2663 16.2C13.1403 16.418 13.1963 16.696 13.3973 16.849L14.2983 17.531C14.2783 17.686 14.2513 17.84 14.2513 18C14.2513 18.161 14.2793 18.314 14.2983 18.469L13.3973 19.151C13.1963 19.303 13.1403 19.581 13.2663 19.8L14.0753 21.201C14.2013 21.419 14.4703 21.51 14.7023 21.412L15.7393 20.974C15.9923 21.167 16.2613 21.337 16.5583 21.461L16.6963 22.562C16.7273 22.812 16.9393 23 17.1913 23H18.8083C19.0603 23 19.2733 22.812 19.3043 22.562L19.4423 21.461C19.7393 21.337 20.0093 21.166 20.2613 20.974L21.2983 21.411C21.5303 21.509 21.7993 21.419 21.9253 21.2L22.7343 19.799C22.8603 19.581 22.8043 19.303 22.6033 19.15L21.7033 18.469ZM18.0003 20C16.8953 20 16.0003 19.105 16.0003 18C16.0003 16.895 16.8953 16 18.0003 16C19.1053 16 20.0003 16.895 20.0003 18C20.0003 19.105 19.1053 20 18.0003 20Z" fill="#B4B7BD"/>' +
                '</g>' +
                '<defs>' +
                '<clipPath id="clip0_802_2076">' +
                '<rect width="24" height="24" fill="white"/>' +
                '</clipPath>' +
                '</defs>',
            'group-roles': '<path d="M20.5358 12.812H18.6797C18.8689 13.33 18.9722 13.889 18.9722 14.4716V21.4864C18.9722 21.7293 18.93 21.9625 18.853 22.1793H21.9215C23.0678 22.1793 24.0002 21.2468 24.0002 20.1006V16.2765C24.0003 14.3662 22.4461 12.812 20.5358 12.812Z" fill="#B4B7BD"/>' +
                '<path d="M5.02806 14.4716C5.02806 13.8889 5.13142 13.33 5.3206 12.812H3.46454C1.55419 12.812 0 14.3662 0 16.2765V20.1007C0 21.2469 0.932486 22.1794 2.07872 22.1794H5.14726C5.07034 21.9624 5.02806 21.7293 5.02806 21.4864V14.4716V14.4716Z" fill="#B4B7BD"/>' +
                '<path d="M14.1218 11.0071H9.8786C7.96825 11.0071 6.41406 12.5613 6.41406 14.4716V21.4865C6.41406 21.8691 6.72428 22.1794 7.10697 22.1794H16.8935C17.2761 22.1794 17.5864 21.8692 17.5864 21.4865V14.4716C17.5864 12.5613 16.0322 11.0071 14.1218 11.0071Z" fill="#B4B7BD"/>' +
                '<path d="M11.9995 1.82056C9.7021 1.82056 7.83301 3.68965 7.83301 5.98714C7.83301 7.54551 8.69312 8.90653 9.96334 9.62109C10.5658 9.96 11.2604 10.1537 11.9995 10.1537C12.7387 10.1537 13.4333 9.96 14.0358 9.62109C15.306 8.90653 16.1661 7.54546 16.1661 5.98714C16.1661 3.6897 14.297 1.82056 11.9995 1.82056Z" fill="#B4B7BD"/>' +
                '<path d="M4.6834 5.7041C2.9652 5.7041 1.56738 7.10192 1.56738 8.82013C1.56738 10.5383 2.9652 11.9362 4.6834 11.9362C5.11924 11.9362 5.53428 11.8459 5.91129 11.6836C6.56314 11.4029 7.10061 10.9062 7.43318 10.2839C7.66662 9.84716 7.79942 9.34893 7.79942 8.82013C7.79942 7.10197 6.40161 5.7041 4.6834 5.7041Z" fill="#B4B7BD"/>' +
                '<path d="M19.3162 5.7041C17.598 5.7041 16.2002 7.10192 16.2002 8.82013C16.2002 9.34897 16.333 9.84721 16.5664 10.2839C16.899 10.9062 17.4365 11.403 18.0883 11.6836C18.4653 11.8459 18.8804 11.9362 19.3162 11.9362C21.0344 11.9362 22.4322 10.5383 22.4322 8.82013C22.4322 7.10192 21.0344 5.7041 19.3162 5.7041Z" fill="#B4B7BD"/>',
            'list-users': '<path d="M8.52 12.1411C8.45114 12.1262 8.38833 12.091 8.33966 12.04C8.291 11.989 8.2587 11.9247 8.24693 11.8552C8.23516 11.7857 8.24446 11.7143 8.27363 11.6502C8.30279 11.586 8.3505 11.5321 8.41059 11.4953C8.52565 11.4248 8.62096 11.3264 8.68763 11.2091C8.75429 11.0918 8.79012 10.9596 8.79176 10.8247C8.79257 10.7217 8.77268 
11.3466 12.8752ZM18.3525 11.4811H11.6996C11.606 11.4811 11.5162 11.4439 11.45 11.3777C11.3838 11.3115 11.3466 11.2218 11.3466 11.1282C11.3466 11.0346 11.3838 10.9448 11.45 10.8786C11.5162 10.8124 11.606 10.7752 11.6996 10.7752H18.3525C18.4461 10.7752 18.5359 10.8124 18.6021 10.8786C18.6683 10.9448 18.7054 11.0346 18.7054 11.1282C18.7054 11.2218 18.6683 11.3115 18.6021 11.3777C18.5359 11.4439 18.4461 11.4811 18.3525 11.4811ZM11.3466 6.31758C11.3466 6.22397 11.3838 6.1342 11.45 6.06801C11.5162 6.00182 11.606 5.96464 11.6996 5.96464H15.0313C15.1249 5.96464 15.2147 6.00182 15.2809 6.06801C15.3471 6.1342 15.3843 6.22397 15.3843 6.31758C15.3843 6.41118 15.3471 6.50096 15.2809 6.56715C15.2147 6.63334 15.1249 6.67052 15.0313 6.67052H11.6996C11.606 6.67052 11.5162 6.63334 11.45 6.56715C11.3838 6.50096 11.3466 6.41118 11.3466 6.31758ZM18.3525 4.94111H11.6996C11.606 4.94111 11.5162 4.90392 11.45 4.83773C11.3838 4.77154 11.3466 4.68177 11.3466 4.58817C11.3466 4.49456 11.3838 4.40479 11.45 4.3386C11.5162 4.27241 11.606 4.23522 11.6996 4.23522H18.3525C18.4461 4.23522 18.5359 4.27241 18.6021 4.3386C18.6683 4.40479 18.7054 4.49456 18.7054 4.58817C18.7054 4.68177 18.6683 4.77154 18.6021 4.83773C18.5359 4.90392 18.4461 4.94111 18.3525 4.94111Z" fill="#B4B7BD"/>'
        ...
        var l = function () {
            ...
            return o(e, [{
                key: "toSvg", value: function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    var str = "<svg " + function (e) {
                        //Xuất SVG
                        return Object.keys(e).map((function (t) {
                            // console.log(JSON.stringify(t));
                            var $stroke = 2;
                            var $listDefine = ['user-define', 'group-roles', 'list-users'];
                            var $thisClass = '';
                                var $thisClass = e['class'].slice(16, e['class'].length);
                            if ($listDefine.includes($thisClass))
                                $stroke = 0;
                            if (t != 'stroke-width')
                                return t + '="' + e[t] + '"'
                            else
        ...
        e.exports = function (e) {
            var t, n, u, p, f = o(e), h = "function" == typeof this ? this : Array, d = arguments.length,
                g = d > 1 ? arguments[1] : void 0, m = void 0 !== g, y = 0, v = c(f);
            if (m && (g = i(g, d > 2 ? arguments[2] : void 0, 2)), null == v || h == Array && a(v)) for (n = new h(t = s(f.length)); t > y; y++) l(n, y, m ? g(f[y], y) : f[y]); else for (p = v.call(f), n = new h; !(u = p.next()).done; y++) l(n, y, m ? r(p, g, [u.value, y], !0) : u.value);
            return n.length = y, n
        }
    }, function (e, t, n) {
        var i = n(32), o = n(54);
        ...
        var i = n(32), o = n(64), r = n(25), a = n(57), s = n(23), l = n(5), c = n(29), u = n(2), p = n(17), f = n(9),
            h = n(26), d = h.IteratorPrototype, g = h.BUGGY_SAFARI_ITERATORS, m = u("iterator"), y = function () {
                return this
            };
        e.exports = function (e, t, n, u, h, v, b) {
            ...
            var x, w, _, k = function (e) {
                ...
                }, E = t + " Iterator", T = !1, S = e.prototype, C = S[m] || S["@@iterator"] || h && S[h],
