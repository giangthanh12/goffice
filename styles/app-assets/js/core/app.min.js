...
window.colors = {
    ...
    "use strict";
    var s = t("html"), n = t("body"), o = "#4e5154", r = baseHome+"/styles/app-assets/";
    if ("laravel" === t("body").attr("data-framework") && (r = t("body").attr("data-asset-path")), t.fn.dataTable && t.extend(t.fn.dataTable.ext.classes, {
        ...
        !1 === t.app.nav.initialized && t.app.nav.init({speed: 300}), Unison.on("change", (function (a) {
            t.app.menu.change(r)
        })), t('[data-toggle="tooltip"]').tooltip({container: "body"}), t('a[data-action="collapse"]').on("click", (function (a) {
        ...
        var l = t(".chartjs"), c = l.children("canvas").attr("height"), d = t(".main-menu");
        ...
        t(".custom-file-input").on("change", (function (a) {
            ...
            !function (e, s) {
                var n = parseInt(t(e).data("length")), r = t(".textarea-counter-value"), i = t(".char-textarea");
                (function (a) {
        ...
        var l = e.querySelector(".drag-target"), c = "panright", d = "panleft";
    ...
    })), t(".navigation").find("li").has("ul").addClass("has-sub"), t(".carousel").carousel({interval: 2e3}), t(a).resize((function () {
    ...
    t(".search-list-main").mouseenter((function () {
        ...
        if (a.stopPropagation(), t(this).hasClass("text-warning")) {
            ...
            n = '<li class="nav-item d-none d-lg-block"><a class="nav-link" href="' + o + '" data-toggle="tooltip" data-placement="top" title="" data-original-title="' + r + '">' + feather.icons[i].toSvg({class: "ficon"}) + "</a></li>", t("ul.nav.bookmark-icons").append(n), t('[data-toggle="tooltip"]').tooltip()
        }
    ...
    t(".nav-link-style").on("click", (function () {
        ...
        e = "dark-layout" !== a ? "dark-layout" : a === n ? "light-layout" : n || "light-layout", localStorage.setItem(T + "-prev-skin", a), localStorage.setItem(T + "-current-skin", e), function (a) {
            var e = t(".nav-link-style"), n = z(), o = t(".main-menu"), r = t(".header-navbar"), i = a || n;
