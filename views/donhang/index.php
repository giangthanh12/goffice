...
<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
		...
		<!-- modal chamsocbaogia-->
            <div class="modal fade text-left" id="thanhtoan" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
            ...
            <div class="card">
                <div>
                    <div class="tab-content">
                        <div class="tab-pane active" id="information" aria-labelledby="information-tab" role="tabpanel">
                            <!-- users edit Info form start -->
                            <table  class="table tablethanhtoan mb-5">
                                <thead>
                                    <th> Thời gian </th>
                                    <th> Nhân viên </th>
                                    <th> Tài khoản </th>
                            ...
                            <form class="form-validate" enctype="multipart/form-data" id="dg-payment">
                                <input type="hidden" id="id_bg" name="id_bg" />
                              
                                <div class="mt-1" style="bottom:0;width:100%;left:0;">
                                     <div class="col-lg-4 col-md-2 float-left" style="z-index:9">
                                        <div class="form-group">
                                            <label for="hoten">Thời gian</label>
                                            <input type="text" class="form-control ngay_gio"  id="ngay_gio_pay" name="ngay_gio_pay" onchange="check_ghichu_csbg()">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-2 float-left" style="z-index:9">
                                        <div class="form-group">
                                            <label for="hoten">Tài khoản</label>
                                            <select name="tai_khoan_pay" id="tai_khoan_pay" class="select2-data-array form-control"></select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-2 float-left" style="z-index:9">
                                        <div class="form-group">
                                            <label for="hoten">Số tiền</label>
                                            <input type="text" class="form-control format_number"  id="so_tien_pay" name="so_tien_pay" onkeyup="check_ghichu_csbg()">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <textarea id="ghi_chu_pay" name="ghi_chu_pay" class="form-control" placeholder="Ghi chú" onkeyup="check_ghichu_csbg()"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12 d-flex flex-sm-row flex-column">
                                        <button type="button" onclick="add_thanhtoan()" class="btn btn-add btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">Thanh toán</button>
                                        <button type="reset" class="btn btn-outline-secondary" data-dismiss="modal">Bỏ qua</button>
                                    </div>
                                </div>
                            </form>
...
<script src="<?= HOME ?>/js/donhang.js"></script>