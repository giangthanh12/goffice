                                    ...
                                    <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                                        <div class="action-tags">
                                            ...
                                            <div class="form-group position-relative">
                                                ...
                                                <select class="select2 form-control" id="managerId"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control" multiple="multiple" id="memberId"
                                                    name="memberId">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <select id="level" class="select2 form-control form-control-lg"
                                                        name="level">
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="task-desc" class="border-bottom-0"
                                                    data-placeholder="Yêu cầu công việc/góp ý"></div>
                                        ...
                                        <div class="form-group position-relative">
                                            ...
                                            <select class="form-control select2 form-control-lg" id="status"
                                                name="status">
                                        ...
                                        <div class="form-group my-1">
                                            ...
                                            <button type="button" class="btn btn-danger update-btn d-none"
                                                data-dismiss="modal" onclick="del()">Xóa</button>
                                            <?php } ?>
