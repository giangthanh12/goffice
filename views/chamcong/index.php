                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <div class="calendar-events-filter">
                                        <div class="custom-control custom-control-secondary custom-checkbox mb-1">
                                            <input type="checkbox" class="custom-control-input input-filter" id="0"
                                                   data-value="0" checked="">
                                            <label class="custom-control-label" for="0">Chưa tính công</label>
                                        </div>
                                        <div class="custom-control custom-control-info custom-checkbox mb-1">
                                            ...
                                            <label class="custom-control-label" for="1">Đủ công</label>
                                        </div>
                                        <div class="custom-control custom-control-success custom-checkbox mb-1">
                                            ...
                                            <label class="custom-control-label" for="2">Nghỉ phép</label>
                                        </div>
                                        <div class="custom-control  custom-control-warning  custom-checkbox mb-1">
                                            ...
                                            <label class="custom-control-label" for="3">Công tác</label>
                                        </div>
                                        <div class="custom-control custom-control-dark custom-checkbox mb-1">
                                            <input type="checkbox" class="custom-control-input input-filter" id="8"
                                                   data-value="8" checked="">
                                            <label class="custom-control-label" for="8">Nghỉ không lương</label>
                                        </div>
                                        <div class="custom-control custom-control-primary custom-checkbox mb-1">
                                            <input type="checkbox" class="custom-control-input input-filter" id="10"
                                                   data-value="10" checked="">
                                            <label class="custom-control-label" for="10">Nghỉ không lý do</label>
                                        </div>
                                        <div class="custom-control custom-control-danger custom-checkbox mb-1">
                                            <input type="checkbox" class="custom-control-input input-filter" id="11"
                                                   data-value="11" checked="">
                                            <label class="custom-control-label" for="11">Đi muộn/về sớm</label>
                                        </div>
                                        <div class="custom-control  custom-checkbox mb-1">
                                            <input type="checkbox" class="custom-control-input input-filter" id="4"
                                                   data-value="4" checked="">
                                            <label class="custom-control-label" for="4">Nghỉ lễ</label>
                                        </div>
                                        <div class="custom-control  custom-checkbox mb-1">
                                            <input type="checkbox" class="custom-control-input input-filter" id="5"
                                                   data-value="5" checked="">
                                            <label class="custom-control-label" for="5">Nghỉ tết</label>
                                        </div>
                                        <div class="custom-control  custom-checkbox mb-1 d-none">
                                            <input type="checkbox" class="custom-control-input input-filter" id="7"
                                                   data-value="7" checked="">
                                            <label class="custom-control-label" for="7">Nghỉ khác có lương</label>
                                        </div>
                                        <div class="custom-control d-none custom-checkbox mb-1">
                                            <input type="checkbox" class="custom-control-input input-filter" id="6"
                                                   data-value="6" checked="">
                                            <label class="custom-control-label" for="6">Nghỉ bù</label>
                                        </div>
                                        <div class="custom-control custom-control-danger custom-checkbox mb-1">
                                            <input type="checkbox" class="custom-control-input input-filter" id="9"
                                                   data-value="9" checked="">
                                            <label class="custom-control-label" for="9">Nghỉ ốm</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
