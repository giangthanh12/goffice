                    ...
                    <div class=" d-flex align-items-center mx-50 row">
                        ...
                        if ($this->funAdd == 1) {
                            ...
                            <button type="button" class="dt-button btn btn-primary mt-50 ml-1" style="margin-top:10px"
                                    title="Lập bảng" onclick="add()">Lập bảng lương
                            </button>
                        <?php }
                        if ($this->funCheck == 1) { ?>
                            <button type="button" class="dt-button btn btn-danger mt-50 ml-1" style="margin-top:10px"
                                    title="Duyệt bảng lương" onclick="checkAll()">Duyệt bảng lương
                            </button>
                        <?php } ?>
                    </div>
                                        ...
                                        <div class="card-body">
                                            <form class="form-validate" enctype="multipart/form-data" id="fm">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="revenueBonus" type="text"
                                                           class="form-control format_number" name="revenueBonus"
                                                           onkeyup="this.value=Comma(this.value)"/>
                                                </div>

                                                <div class="form-group">
                                                    <label for="tetBonus">Thưởng lễ tết</label>
                                                    <input id="tetBonus" type="text" class="form-control format_number"
                                                           name="tetBonus" onkeyup="this.value=Comma(this.value)"/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="otherBonus">Thưởng khác</label>
                                                    <input id="otherBonus" type="text"
                                                           class="form-control format_number" name="otherBonus"
                                                           onkeyup="this.value=Comma(this.value)"/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="insurance">Bảo hiểm</label>
                                                    <input id="insurance" type="text" class="form-control format_number"
                                                           name="insurance" onkeyup="this.value=Comma(this.value)"/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="advance">Tạm ứng</label>
                                                    <input id="advance" type="text" class="form-control format_number"
                                                           name="advance" onkeyup="this.value=Comma(this.value)"/>
                                                </div>
