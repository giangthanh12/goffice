            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    ...
                    <h2 class="content-header-title float-left mb-0" id="title_module" style="border-right-width: 0px;">
                        Tình trạng công việc    <img src="<?=HOME?>/layouts/tooltip.png" style="margin: 0 15px" width="25px" id="current_ip" data-toggle="tooltip" data-placement="right" data-original-title="Là chức năng thiết lập và quản lý nhiều tình trạng khác nhau của một công việc" data-trigger="click" >
                    </h2>
                    </div> 
                                        ...
                                        <div class="card-body">
                                            <form class="form-validate" enctype="multipart/form-data" id="dg">
                                                <div class="row mt-1">
                                                    ...
                                                    <label for="link">Tên tình trạng<span style="color:red;">*</span></label>
