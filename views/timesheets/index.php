                ...
                <div class="card">
                    ...
                    <div class="d-flex align-items-center mx-50 row">
                        <?php if ($this->funAdd == 1) { ?>
                            <button type="button" class="dt-button btn btn-primary mt-50 ml-1" style="margin-top:10px" title="Lập bảng" onclick="add()">Lập bảng
                            </button>
                        <?php } ?>
                        <?php if ($this->funEdit == 1) { ?>
                            <button type="button" class="dt-button btn btn-danger mt-50 ml-1" style="margin-top:10px" title="Lập bảng" onclick="update()">Chấm công tay
                            </button>
                        <?php } ?>
                            ...
                            <form class="form-validate" enctype="multipart/form-data" id="fm">
                                <div class="col-12">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <select class="select2 form-control" id="staffId" name="staffId" placeholder="Nhân viên" required>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control work-due-date" id="startDate" name="startDate" required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control work-due-date" id="endDate" name="endDate" required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
