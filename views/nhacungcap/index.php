                ...
                <div class="card">
                    ...
                    <div class="modal fade text-left" id="nhapexcel" tabindex="-1" aria-labelledby="myModalLabel18" aria-hidden="true" role="dialog">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="modal-title1">Nhập nhà cung cấp từ excel</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                ...
                                <div class="modal-body">
                                    <form id="fm-nhapexcel">
                                        <div class="form-group">
                                            ...
                                            <a target="_blank" href="<?= URLFILE ?>/uploads/khachhang.xlsx" style="color: blue;">Link</a>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary waves-effect waves-float waves-light" data-dismiss="modal" onclick="savenhap()">Accept</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="<?= HOME ?>/js/nhacungcap.js"></script>