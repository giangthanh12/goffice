                ...
                <div class="card">
                    <div class="d-flex justify-content-between align-items-center mx-50 row pt-2 pb-2">
                        <h2 class="content-header-title float-left mb-0" id="title_module" style="border-right-width: 0px;">
                            Chiến dịch tuyển dụng <img src="<?= HOME ?>/layouts/tooltip.png" style="margin: 0 15px" width="25px" id="current_ip" data-toggle="tooltip" data-placement="right" data-original-title="Là chức năng quản lý thông tin chiến dịch tuyển dụng  " data-trigger="click">
                        </h2>
                    </div>
                                                ...
                                                <div class="row mt-1">
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="title">Tên chương trình<span style="color:red;">*</span></label>
                                                            <input id="title" type="text" class="form-control" name="title" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="inChargeId">Người phụ trách chương trình<span style="color:red;">*</span></label>
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="followerId" multiple="multiple" data-msg-required="Yêu cầu chọn thành viên" class="select2 form-control" name="followerId[]">
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="estimateCost">Chi phí ước tính<span style="color:red;">*</span></label>
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="branch">Chi nhánh tuyển dụng<span style="color:red;">*</span></label>
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="position">Vị trí tuyển dụng<span style="color:red;">*</span></label>
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="minSalary">Lương/phụ cấp tối thiểu<span style="color:red;">*</span></label>
                                                            <input id="minSalary" name="minSalary" type="text" class="form-control format_number" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="maxSalary">Lương/phụ cấp tối đa<span style="color:red;">*</span></label>
                                                            <input id="maxSalary" type="text" class="form-control format_number" name="maxSalary" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="quantity">Số lượng tuyển dụng<span style="color:red;">*</span></label>
                                                            <input id="quantity" type="text" class="form-control" name="quantity" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="minAge">Độ tuổi tối thiểu<span style="color:red;">*</span></label>
                                                            <input id="minAge" type="text" class="form-control" name="minAge" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="maxAge">Độ tuổi tối đa<span style="color:red;">*</span></label>
                                ...
                                <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                                    <form id="interviewForm" class="event-form needs-validation" data-ajax="false" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="noteCalendar" id="noteCalendar" class="form-control"></textarea>
                                        </div>
