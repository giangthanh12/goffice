                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="custom-control custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" onclick="checkRole(this.checked,1)" id="admin-read" checked />
                                                                                    <label class="custom-control-label" for="admin-read">Thêm</label>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="custom-control custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="admin-write" />
                                                                                    <label class="custom-control-label" for="admin-write">Sửa</label>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="custom-control custom-checkbox">
