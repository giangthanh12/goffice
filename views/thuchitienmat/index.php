                                            ...
                                            <form class="form-validate" enctype="multipart/form-data" id="dg">
                                                <div class="row mt-1">
                                                    ...
                                                    <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                                                        <button type="button" id="btn_add" onclick="savethuchitienmat()" class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">Cập nhật</button>
...
<script src="<?= HOME ?>/js/thuchitienmat.js"></script>