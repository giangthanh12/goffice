        ...
        <div class="content-body">
            <div class="card">
                ...
                <h2 class="content-header-title float-left mb-0" id="title_module">
                        Báo cáo chi phí <img src="<?=HOME?>/layouts/tooltip.png" style="margin: 0 15px" width="25px" id="current_ip" data-toggle="tooltip" data-placement="right" data-original-title="Là chức năng điểm danh" data-trigger="click" >
                    </h2>
