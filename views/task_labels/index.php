            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    ...
                    <h2 class="content-header-title float-left mb-0" id="title_module" style="border-right-width: 0px;">
                       Nhãn công việc <img src="<?= HOME ?>/layouts/tooltip.png" style="margin: 0 15px" width="25px" id="current_ip" data-toggle="tooltip" data-placement="right" data-original-title="Là chức năng thiết lập và quản lý nhiều cấp độ khác nhau của một công việc" data-trigger="click">
                    </h2>
                    </div>
                                            ...
                                            <form class="form-validate" enctype="multipart/form-data" id="dg">
                                                <div class="row mt-1">
                                                    <div class="col-md-12 form-group">
                                                        <label for="link">Tên nhãn<span style="color:red;">*</span></label>
