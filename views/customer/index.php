                                        ...
                                        <div class="card-body">
                                            <form class="form-validate" enctype="multipart/form-data" id="dg">
                                                <div class="row mt-1">
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="field">Lĩnh vực của khách hàng</label>
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="bussinessAddress">Địa chỉ doanh nghiệp khách hàng</label>
                                                            <input id="bussinessAddress" type="text" class="form-control" name="bussinessAddress" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="bussinessPlace">Vị trí doanh nghiệp khách hàng</label>
                                                            <input id="bussinessPlace" type="text" class="form-control" name="bussinessPlace" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="authorized">Người cấp phép</label>
                                                            <input id="authorized" type="text" class="form-control" name="authorized" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="type">Loại hình hoạt động</label>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="information" aria-labelledby="information-tab" role="tabpanel">
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="office1">Tên văn phòng khách hàng</label>
                                                            <input id="office1" type="text" class="form-control" name="office1" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                                                            <label for="fieldDetail1">Mô tả lĩnh vực</label>
                                                            <input id="fieldDetail1" name="fieldDetail1" type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="form-group">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <a target="_blank" href="<?= URLFILE ?>/uploads/newData1.xlsx" style="color: blue;">Tải xuống <i class="fas fa-download"></i></a>
