            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    ...
                    <h2 class="content-header-title float-left mb-0" id="title_module" style="border-right-width: 0px;">
                        Cấp độ dự án    <img src="<?=HOME?>/layouts/tooltip.png" style="margin: 0 15px" width="25px" id="current_ip" data-toggle="tooltip" data-placement="right" data-original-title="Là chức năng thiết lập và quản lý nhiều cấp độ khác nhau của một dự án" data-trigger="click" >
                    </h2>
                    </div>
...
<script src="<?= HOME ?>/js/project_levels.js"></script>