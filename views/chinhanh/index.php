            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    <div class="d-flex justify-content-between align-items-center mx-50 row pt-2 ">
                        <img src="<?=HOME?>/layouts/tooltip.png" style="margin: 0 15px" width="25px" id="current_ip" data-toggle="tooltip" data-placement="right" data-original-title="Quản lý các đơn vị làm việc trực thuộc của doanh nghiệp" data-trigger="click" >
                    </div>
