...
<head>
    ...
    <script>
        ...
        let baseApi = '<?= URLAPI; ?>';
        let baseUser = '<?= $_SESSION['user']['nhan_vien']; ?>';
        let baseHome = '<?= HOME ?>';
        var baseUrl = '<?= URL ?>';
        let baseUrlFile = '<?= URLFILE ?>';
        let now = '<?= date('Y-m-d H:i:s') ?>';
        let user = JSON.parse(localStorage.getItem("nhanvien"));
    </script>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none">
                            <span class="user-name font-weight-bolder" id="hungsua1"><?= $_SESSION['user']['hoten'] ?></span>
                            <span class="user-status"><?= $_SESSION['user']['email'] ?></span>
                        </div>
                        <span class="avatar">
                            <img class="round" src="<?= $_SESSION['user']['hinhanh'] ?>" alt="avatar" height="40" width="40" id="hungsua2">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item">
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="d-flex align-items-center" href="vanban">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="LoginV1">Văn bản chung</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="bieumau">
                                <i data-feather="circle"></i>
                ...
                <li class="nav-item has-sub" style="">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Form Layout">Tài sản</span>
                    </a>
                    <ul class="menu-content">
                        <li>
                            <a class="d-flex align-items-center" href="taisannhom">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="LoginV1">Nhóm tài sản</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="taisan">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="LoginV1">Tài sản</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="taisancapphat">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="LoginV1">Cấp phát</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="taisanthuhoi">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="LoginV1">Thu hồi</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="taisankhauhao">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="LoginV1">Khấu hao</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="baohanh">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="LoginV1">Bảo hành</span>
                            </a>
                        </li>
                ...
                <li class=" nav-item">
                    ...
                    <ul class="menu-content">
                        ...
                        <li>
                            <a class="d-flex align-items-center" href="phongban">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="View">Phòng ban</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="chinhanh">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Edit">Chi nhánh</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="vitri">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Edit">Vị trí</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item">
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="d-flex align-items-center" href="thongtincongty">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Authentication">Thông tin công ty</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="ca">
                                <i data-feather="circle"></i>
                        ...
                        <li>
                            <a class="d-flex align-items-center" href="tamung">
                                <i data-feather="circle"></i>
                ...
                <li class=" nav-item">
                    ...
                    <ul class="menu-content">
                        ...
                        <li>
						 ...
						 <li>
                            <a class="d-flex align-items-center" href="baogia">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Card Actions">Báo giá</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item">
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="d-flex align-items-center" href="thuchutienmat">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Basic">Sổ tiền mặt</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="thuchinganhang">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Advanced">Sổ ngân hàng</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="taikhoan">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Advanced">Tài khoản ngân hàng</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item">
                    ...
                    <ul class="menu-content">
                        ...
                        <li>
                            <a class="d-flex align-items-center" href="hopdongld">
                                <i data-feather="circle"></i>
                ...
                <li class=" nav-item">
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="d-flex align-items-center" href="bhxh">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Third Level">Danh sách</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="bhxh-lichsu">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Third Level">Đóng BHXH</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="bhxh-baogiam">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Third Level">Báo giảm</span>
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    <!-- <div class="modal fade text-left" id="readmsg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true" value="">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="sidebar-left">
                        ...
                        <br>
                        <h5 id="mess_sender">Tran Hai</h5>
                    </div>
                    <div class="content-right" style="width: calc(100vw - (100vw - 100%) - 100px); !Important">
                        <div class="mail-message">
                            <h5 id="mess_subject">Lưu ý hoàn thành deadline</h5>
                            <p class="mb-0 " id="mess_body">Hôm nay là thứ tư rồi đó Hôm nay là thứ tư rồi đó Hôm nay là thứ
                                tư rồi đó Hôm nay là thứ tư rồi đó Hôm nay là thứ tư rồi đó Hôm nay là thứ tư rồi đó Hôm nay
                                là thứ tư rồi đó </p>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <a id="xemchitiet" href="inbox" class="btn btn-info">Xem chi tiết</a>
                    <button type="button" class="btn btn-primary" data-dismiss="modal">Đóng</button>
                    <a href="inbox" class="btn btn-danger" data-dismiss="modal" onclick="delmsg()">Xóa</a>
                </div>
            </div>
        </div>
    </div> -->
