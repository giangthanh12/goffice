              ...
              <a class="nav-link nav-link-style">
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="avatar">
                            <img class="round" src="<?= $_SESSION['user']['avatar'] ?>" alt="avatar" height="40" width="40" id="hungsua2">
                    ...
                    <ul class="menu-content">
                        ...
                        <li>
                            <a class="d-flex align-items-center" href="ca">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Account Settings">Phân ca</span>
                            </a>
                        </li>
                        <li>
                ...
                <li class=" nav-item">
                    ...
                    <ul class="menu-content">
                        ...
                        <li>
						 ...
						 <li>
                            <a class="d-flex align-items-center" href="donhang">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Card Actions">Đơn hàng</span>
                            </a>
                        </li>
                    </ul>
                </li>
