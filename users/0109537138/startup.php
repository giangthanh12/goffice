...
define('DB_NAME', 'goffice_0109537138');
define('DB_USER', 'root');
define('DB_PASS', '');
...
define('URL', 'http://' . $_SERVER['HTTP_HOST'] . '/goffice/0109537138');
define('ROOT_DIR', $_SERVER['DOCUMENT_ROOT'] . '/goffice/users/0109537138' );
define('URLFILE', 'http://' . $_SERVER['HTTP_HOST'] . '/goffice/users/0109537138');
?>
