$(function () {
    ...
    var dtUserTable = $(".user-list-table"),
        ...
        $.ajax({ // tải Khách hàng vào select1 khach_hang
            ...
            dataType: "json",
            async: false,
            url: baseHome + "/thuchitienmat/khachhang",
        ...
        $.ajax({ // tải Nhân viên vào select1 nhan_vien
            ...
            dataType: "json",
            async: false,
            url: baseHome + "/thuchitienmat/nhanvien",
            success: function (data) {
    ...
    if (dtUserTable.length) {
        dtUserTable.DataTable({
            ...
            ajax: baseHome + "/thuchitienmat/list",
            "ordering": false,
            columns: [
            ...
            buttons: [
                {
                    ...
                    action: function (e, dt, node, config) {
                        ...
                        url = baseHome + "/thuchitienmat/add";
                    },
                },
...
function loaddata(id) {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: { id: id },
        url: baseHome + "/thuchitienmat/loaddata",
        success: function (data) {
            ...
            url = baseHome + '/thuchitienmat/update?id=' + id;
        },
        error: function () {
...
function xoa(id) {
    $.ajax({
        url: baseHome + "/thuchitienmat/del",
        type: 'post',
        dataType: "json",
        data: { id: id },
        success: function (data) {
...
function chot_so_du() {
    $.ajax({
        ...
        dataType: "json",
        data: {},
        url: baseHome + "/thuchitienmat/chotsodu",
        success: function (data) {
            if (data.success) {
                notyfi_success(data.msg);
                $(".user-list-table").DataTable().ajax.reload(null, false);
