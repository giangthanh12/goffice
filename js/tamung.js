    ...
    if (tinhtrang != 2) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.custom-file-label').html('Chọn file');
                url = baseHome + '/tamung/update?id=' + id;
            },
            error: function () {
