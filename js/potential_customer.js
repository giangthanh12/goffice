...
$(function () {
    "use strict";
    return_combobox_multi('#staffId', baseHome + '/potential_customer/getStaff', 'Chọn nhân viên chăm sóc');
    return_combobox_multi('#nationalId', baseHome + '/potential_customer/getNational', 'Chọn quốc gia');
    return_combobox_multi('#staffId1', baseHome + '/potential_customer/getStaff', 'Chọn nhân viên chăm sóc');
    return_combobox_multi('#staffId2', baseHome + '/potential_customer/getStaff', 'Chọn nhân viên chăm sóc');
    return_combobox_multi('#nationalId1', baseHome + '/potential_customer/getNational', 'Chọn quốc gia');
    return_combobox_multi('#provinceId', baseHome + '/potential_customer/getProvince', 'Chọn tỉnh thành');
    return_combobox_multi('#provinceId1', baseHome + '/potential_customer/getProvince', 'Chọn tỉnh thành');
    // return_combobox_multi('#provinceId2', baseHome + '/potential_customer/getProvince', 'Chọn tỉnh thành');
    load_select2($('#provinceId2'), baseHome + '/potential_customer/getProvince', 'Chọn tỉnh thành');
    ...
    if (dtUserTable.length) {
        var table = dtUserTable.DataTable({
            ...
            ajax: baseHome + "/potential_customer/list",
            autoWidth: false,
            ordering: false,
            columns: [
                { data: "fullName" },
...
function loaddata(id) {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: { id: id },
        url: baseHome + "/potential_customer/loaddata",
        success: function (data) {
...
function loaddichvu(id) {
    ...
    if (dtDVTable.length) {
        ...
        dtDVTable.DataTable({
            ajax: baseHome + "/potential_customer/loadContact?id=" + id,
            destroy: true,
...
function loadTransaction(id) {
    ...
    if (transactionTable.length) {
        ...
        transactionTable.DataTable({
            ajax: baseHome + "/potential_customer/loadTransaction?id=" + id,
            destroy: true,
...
function loaddataTransaction(id) {
    return_combobox_multi('#performedId', baseHome + '/potential_customer/getStaff', 'Nhân viên thực hiện');
    $('#modalTransaction').modal('show');
    $.ajax({
        type: "POST",
        dataType: "json",
        data: { id: id },
        url: baseHome + "/potential_customer/loaddataTransaction",
        success: function (data) {
            // Default
            ...
            urlTransaction = baseHome + '/potential_customer/saveTransaction?id=' + id;
        },
        error: function () {
            notify_error('Lỗi truy xuất database');
        }
...
function delTransaction(id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: baseHome + "/potential_customer/delTransaction",
                type: 'post',
                dataType: "json",
                data: { id: id },
                success: function (data) {
...
function showFormTransaction() {
    ...
    urlTransaction = baseHome + "/potential_customer/saveTransaction";
}
...
function saveadd() {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: info,
        url: baseHome + "/potential_customer/add",
        success: function (data) {
            if (data.success) {
                notyfi_success(data.msg);
                $('.modal').modal('hide');
...
function saveedit() {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: info,
        url: baseHome + '/potential_customer/update?id=' + khid,
        success: function (data) {
            if (data.success) {
                notyfi_success(data.msg);
                $('.modal').modal('hide');
...
function del(id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: baseHome + "/potential_customer/del",
                type: 'post',
                dataType: "json",
                data: { id: id },
                success: function (data) {
...
function savenhap() {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: myform,
        url: baseHome + "/potential_customer/importExcel",
        contentType: false,
        processData: false,
        success: function (data) {
            if (data.success) {
...
$(document).on('blur', '.phoneNumber', function () {
    ...
    if (phone != '' && phone.toString().length >= 10) {
        $.ajax({
            ...
            url: baseHome + "/potential_customer/checkPhone",
            success: function (data) {
                if (data.success) {
                    notyfi_success(data.msg);
                    if (id == 'phoneNumber') {
