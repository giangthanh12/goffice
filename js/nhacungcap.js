            ...
            buttons: [
                {
                    ...
                    action: function (e, dt, node, config) {
                        ...
                        $('#tinh_trang').val('1');
                        $('#phan_loai').attr("disabled", true);
                        $('#phan_loai').val(2);
                        $('#ghi_chu').val('');
                        url = baseHome + "/nhacungcap/add";
                    },
                },
                {
                    text: "Nhập excel",
...
function loaddata(id) {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: { id: id },
        url: baseHome + "/nhacungcap/loaddata",
        success: function (data) {
            $('#name').val(data.name);
            ...
            $('#phan_loai').attr("disabled", false);
            $('#phan_loai').val(data.phan_loai);
            $('#ghi_chu').val(data.ghi_chu);
            url = baseHome + '/nhacungcap/update?id=' + id;
        },
        error: function () {
...
function savenhap() {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: myform,
        url: baseHome + "/nhacungcap/nhapexcel",
        contentType: false,
        processData: false,
        success: function (data) {
            if (data.success) {
