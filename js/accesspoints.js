...
function loaddata(id) {
    $("#dgAccesspoint").modal('show');
    $(".modal-title").html('Cập nhật thông tin điểm truy cập');
    $.ajax({
        type: "POST",
        dataType: "json",
        data: {id: id},
        url: baseHome + "/accesspoints/loaddata",
        success: function (data) {
            $('#name').val(data.name);
            $('#address').val(data.address);
            $('#ip').val(data.ip);

            url = baseHome + '/accesspoints/update?id=' + id;
        },
        error: function () {
